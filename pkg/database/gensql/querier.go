...
type Querier interface {
	...
	GetDataproduct(ctx context.Context, id uuid.UUID) ([]DataproductCompleteView, error)
	GetDataproducts(ctx context.Context, arg GetDataproductsParams) ([]DataproductCompleteView, error)
	GetDataproductsByGroups(ctx context.Context, groups []string) ([]DataproductCompleteView, error)
	GetDataproductsByIDs(ctx context.Context, ids []uuid.UUID) ([]DataproductCompleteView, error)
	GetDataproductsByProductArea(ctx context.Context, teamID []string) ([]DataproductCompleteView, error)
	GetDataproductsByTeam(ctx context.Context, teamID sql.NullString) ([]DataproductCompleteView, error)
	GetDataset(ctx context.Context, id uuid.NullUUID) ([]DataproductCompleteView, error)
	GetDatasetMappings(ctx context.Context, datasetID uuid.UUID) (ThirdPartyMapping, error)
	GetDatasetsByMapping(ctx context.Context, arg GetDatasetsByMappingParams) ([]DataproductCompleteView, error)
	GetDatasetsByUserAccess(ctx context.Context, id string) ([]DataproductCompleteView, error)
	GetDatasetsForOwner(ctx context.Context, groups []string) ([]DataproductCompleteView, error)
	...
	GetMinimalDataproductsByIDs(ctx context.Context, ids []uuid.UUID) ([]Dataproduct, error)
