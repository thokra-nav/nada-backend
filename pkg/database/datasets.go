	...
	for _, dsrow := range dsrows {
		...
		if dsrow.BqID != uuid.Nil {
			...
			dsrc := models.BigQuery{
				...
				ProjectID:     dsrow.BqProject.String,
				Dataset:       dsrow.BqDataset.String,
				Table:         dsrow.BqTableName.String,
				TableType:     models.BigQueryType(dsrow.BqTableType.String),
				Created:       dsrow.BqCreated.Time,
				LastModified:  dsrow.BqLastModified.Time,
